...
namespace StreetFood.DAL.Migrations
{
    ...
    [Migration("20221117143552_UpdatePropertiesTables")]
    partial class UpdatePropertiesTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StreetFood.Entities.Content", b =>
                {
                    ...
                    b.HasOne("StreetFood.Entities.Ingredient", "Ingredients")
                        .WithMany()
            ...
            modelBuilder.Entity("StreetFood.Entities.Order", b =>
                {
                    b.HasOne("StreetFood.Entities.Dish", "Dish")
                        .WithOne("Order")
                        .HasForeignKey("StreetFood.Entities.Order", "DishId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
